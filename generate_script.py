...
for elem in BYTECODES:
	...
	if elem[2] == '1':
		...
		print 'error'
		exit(0)
	fscript.write(SF%(elem[1], elem[0], "bytecodearg", mask, elem[2]))
fscript.write(bytecodetail)
fscript.write(dis)
fscript.write(disvm)

print 'Generating debug.x done!'
